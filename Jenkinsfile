    ...
    stages{
        ...
        stage('sonar') {
            steps{
                ...
                dotnet sonarscanner begin /o:myorganisationysp k:myorganisationysp_pitstop /d:sonar.host.url=https://sonarcloud.io  sh "dotnet build src/pitstop" dotnet sonarscanner end
            }
        }
